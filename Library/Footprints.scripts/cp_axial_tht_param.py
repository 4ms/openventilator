...
kicad_naming_params_axial_th_cap = {
    ...
    "CP_Axial_L26.0mm_D13.0mm_P33.02mm_Horizontal" : Params(# for Medtronic
        L = 26.00, # Body Length
        D = 13.00, # Body Diameter
        d = 0.80, # Lead Diameter
        F = 33.02, # Lead Seperation
        ll = 2.0, # Lead Length
        bs = 0.0, # Board Seperation
        rotation = 180, # Rotation
    ),

    "CP_Axial_L27.0mm_D13.0mm_P30.48mm_Horizontal" : Params(# for Medtronic
        L = 27.00, # Body Length
        D = 13.00, # Body Diameter
        d = 0.90, # Lead Diameter
        F = 30.48, # Lead Seperation
        ll = 2.0, # Lead Length
        bs = 0.0, # Board Seperation
        rotation = 0, # Rotation
    ),
    ...
    "CP_Axial_L30.0mm_D10.0mm_P40.64mm_Horizontal" : Params(# from Jan Kriege's 3d models
        L = 30.00, # Body Length
        D = 10.00, # Body Diameter
        d = 0.80, # Lead Diameter
        F = 40.64, # Lead Seperation
        ll = 2.0, # Lead Length
        bs = 0.0, # Board Seperation
        rotation = 180, # Rotation
    ),
